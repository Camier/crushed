...
# Start vLLM for Dolphin Llama3 ZH with configurable defaults.

MODEL_ROOT="${CRUSH_LOCAL_MODELS:-$HOME/.local/share/crush/models}"
MODEL_PATH="${MODEL_PATH:-${MODEL_ROOT}/vllm/dolphin-llama3-zh}"
MODEL_NAME="${MODEL_NAME:-dolphin-llama3-zh}"
HOST="${HOST:-127.0.0.1}"
PORT="${PORT:-8002}"
